<?php
    ...
    * 																		*
    *************************************************************************
	* mkios/accountReceivable.php :: MKios Page								*
	*********************************************************************
	...
	*********************************************************************/
	...
	//*** BEGIN INITIALIZATION ********************************************************//
		...
		if ( count($_SESSION) > 0 && isset($_SESSION['user_ID']) && $_SESSION['user_ID'] > 0 
		  && (strtolower($_SESSION['user_Name']) == "admin" || strtolower($_SESSION['user_Name']) == "mkios") )
		{
			//do nothing
		}
		else
	...
	$websiteFiles = array(
		...
		"content" => "mkios/accountReceivable.htm"
	);
	...
	$cWebsite->template->set_var(array(
		...
		"VAR_FORMACTION" => "mkios/accountReceivable.php"
	));
