<?php
    ...
    * 																		*
    *************************************************************************
	* master/reportSalesPrint.php :: Master Sales Report Page				*
	****************************************************************************
	* The full sales report print page for master							*
	*															*
	* Version			: 1											*
	...
	***************************************************************************/
	...
	//*** BEGIN PAGE PROCESSING *************************************************//
		...
		$sSearchPaymentTypeName = "All Payment Types";		
	...
	$websiteFiles = array(
		"site" => "master/reportSalesPrint.htm"
	);
	...
	for ($i = 0; $i < count($aPaymentTypeList); $i++)
	{
		$paymentTypeListBlock[] = array(
			...
			"VAR_PAYMENTTYPESELECTED" => ($aPaymentTypeList[$i]['ID'] == $_GET['reportPaymentType'])?"selected":""
		);
	}
