<?php
    ...
    * 																		*
    *************************************************************************
	* master/reportTransfer.php :: Retail Transfer Page					*
	****************************************************************************
	...
	***************************************************************************/
	...
	//*** BEGIN PAGE PROCESSING *************************************************//
		...
		if ( count($_POST) > 0 ) //$_POST is always set, so we check by # of element
		{
			...
			{
				$aPostData = array(
					"From_outlet_ID" => $_POST["transferOutletFrom"],
					"To_outlet_ID" => $_POST["transferOutletTo"],
					"DateFrom" => $sDateFrom,
					"DateTo" => $sDateTo,
	...
	$websiteFiles = array(
		...
		"content" => "master/reportTransfer.htm"
	);
