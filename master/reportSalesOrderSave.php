<?php
    ...
    * 																		*
    *************************************************************************
	* master/reportSalesOrderSave.php :: Master Report Sales order save Page	*
	****************************************************************************
	* The full sales order report save page for master						*
	*															*
	* Version			: 1											*
	...
	***************************************************************************/
	...
	//*** BEGIN PAGE PROCESSING *************************************************//
		...
		if (isset($_GET['reportSpecialTax']) && $_GET['reportSpecialTax'] == 1)
		{
			$sSearchProductName .= " - Include Special Tax";
		}
		else
		{
			$sSearchProductName .= " - No Special Tax";
		}
	...
	$websiteFiles = array(
		"site" => "master/reportSalesOrder.htm"
	);
...
//echo "here";
	...
	*/
	...
	$cExport->output_file('reportSalesOrderSave-' . $sSearchOutletName . '-' . $sBeginDate . '-' . $sEndDate . '.csv', 'text/plain'); //output the file for download
