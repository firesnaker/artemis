	...
	*********************************************************************/
	...
	//*** BEGIN INITIALIZATION ********************************************************//
		...
		if ( count($_SESSION) > 0 && isset($_SESSION['user_ID']) && $_SESSION['user_ID'] > 0 
		  && (strtolower($_SESSION['user_Name']) == "admin" || strtolower($_SESSION['user_Name']) == "audit") )
		{
			//do nothing
		}
		else
	...
	$websiteFiles = array(
		...
		"content" => "audit/accountReceivable-mkios.htm"
	);
	...
	$cWebsite->template->set_var(array(
		...
		"VAR_FORMACTION" => "audit/accountReceivable-mkios.php"
	));
