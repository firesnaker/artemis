<?php
	/***************************************************************************
	* audit/sales_order.php :: Audit Sales Order Verification Page			*
	*********************************************************************
	* The sales order verification page for audit						*
	*															*
	* Version			: 0.1										*
	* Author			: FireSnakeR 									*
	* Created			: 2013-12-06 									*
	...
	*********************************************************************/
	...
	//*** BEGIN PAGE PROCESSING *************************************************//
		...
		{
			$aSearchByFieldArray["Status"] = $_POST['FinStatus'];
		}
	...
	foreach($aGroupedSalesList as $key => $value)
	{
		...
		for ($i = 0; $i < count($value); $i++)
		{
			...
			$reportListBlock[] = array(
				...
				"VAR_DEBIT" => $i,
				"VAR_TRANSFER" => $i,
				"VAR_FINANCESTATUS" => ($value[$i]['Status'] == 1)?"Verified":"Not Verified",
				"VAR_FINANCENOTES" => $value[$i]['FinanceNotes'],
			);
		}
