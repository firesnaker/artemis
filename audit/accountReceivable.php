<?php
    ...
    * 																		*
    *************************************************************************
	* audit/accountReceivable.php :: Profit Loss Page								*
	*********************************************************************
	* The account receivable page for audit											*
	...
	*********************************************************************/
	...
	$websiteFiles = array(
		...
		"content" => "audit/accountReceivable.htm"
	);
	...
	$cWebsite->template->set_var(array(
		...
		"VAR_FORMACTION" => "audit/accountReceivable.php"
	));
