<?php
    ...
    * 																		*
    *************************************************************************
	* admin/outletImport.php :: Admin Outlet Import Page					*
	****************************************************************************
	* The outlet batch import page for admin							*
	*															*
	* Version			: 1											*
	...
	***************************************************************************/
	...
	//*** BEGIN PAGE PROCESSING *************************************************//
		...
		if ( count($_POST) > 0 ) //$_POST is always set, so we check by # of element
		{
			...
			{
				if (($handle = fopen($_FILES["outletFile"]["tmp_name"], "r")) != FALSE)
				{
	...
	$websiteFiles = array(
		...
		"content" => "admin/outletImport.htm"
	);
	...
	$cWebsite->template->set_var(array(
		...
		"VAR_FORM_ACTION" => "admin/outletImport.php",

		"TEXT_LEGEND_OUTLETIMPORT" => strtoupper("Outlet Batch Import"), //TODO: change into language variables
