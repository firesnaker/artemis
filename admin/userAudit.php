<?php
	/***************************************************************************
	* admin/userAudit.php :: Admin User Audit Page						*
	****************************************************************************
	* The user audit profile view/edit page for admin						*
	*															*
	* Version			: 1											*
	...
	***************************************************************************/
	...
	//*** BEGIN PAGE PROCESSING *************************************************//
		...
		if ( count($_POST) > 0 ) //$_POST is always set, so we check by # of element
		{
			...
			if ( $cValidator->isValidType($_POST, $aValidType))
			{
				...
				$aUserData = $cUser->GetUserByUsername("audit");
	...
	$websiteFiles = array(
		...
		"content" => "admin/userFinance.htm" //we reuse the userFinance page
	);
	...
	$cWebsite->template->set_var(array(
		...
		"VAR_FORM_ACTION" => "admin/userAudit.php",
		...
		"VAR_USER_NAME" => "AUDIT", //TODO: change into language variables
		"TEXT_LABEL_USERNAME" => "Username", //TODO: change into language variables
		"VAR_USER_USERNAME" => "audit", //TODO: change into language variables
