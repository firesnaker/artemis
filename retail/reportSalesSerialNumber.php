<?php
    ...
    * 																		*
    *************************************************************************
	* retail/reportSalesSerialNumber.php :: Retail Sold SN Report Page		*
	****************************************************************************
	* The sold serial number report page for retail						*
	*															*
	* Version			: 1											*
	...
	***************************************************************************/
	...
	$sMessages = FALSE;
	$sPageName = "Sold SN Report";
	$iInventoryProduct = 0;
	$iInventoryProductCategory = 0;
	...
	//*** BEGIN PAGE PROCESSING *************************************************//
		...
		if ( count($_POST) > 0 ) //$_POST is always set, so we check by # of element
		{
			...
			$iInventoryProductCategory = $_POST['reportProductCategory'];
		}
		else
		{
	...
	$cWebsite->template->set_var(array(
		...
		"VAR_FORMACTION" => "retail/reportSalesSerialNumber.php",
		"VAR_FORMSAVE" => "retail/reportSalesSerialNumberSave.php",
		"VAR_INVENTORYPRODUCT" => (isset($_POST['inventoryProduct']))?$_POST['inventoryProduct']:"0",
		"VAR_INVENTORYPRODUCTCATEGORY" => (isset($_POST['reportProductCategory']))?$_POST['reportProductCategory']:"0",
